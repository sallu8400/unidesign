...
//   // --- States ---
//   const [dsgData, setDsgData] = useState([]); // List for Second Dropdown
//   const [designCode, setDesignCode] = useState(""); 
//   const [isDropdownOpen, setIsDropdownOpen] = useState(false); 

//   const [catData, setCatData] = useState([]); // List for First Dropdown
...
//       console.log(`Designs fetched for category ${category}:`, dataToSet);
//     } catch (err) {
//       console.error("Filtered Design API Error:", err);
//       setDsgData([]); // Error aane par list khali kar do
//     }
//   };

//   // --- Handlers ---

//   // HANDLER 1: Jab user Category select kare (Left Input)
//   const handleCatSelect = (item) => {
   
//     setFormData(prev => ({ ...prev, DmTcTyp: item.dmctg }));
    
//     // 2. Dropdown band karo
...
//     fetchDesignsByCategory(item.dmctg);
//   };
...
//                         key={index} 
//                         className="grid-row"
//                         onMouseDown={() => handleCatSelect(row)} // Call filtered logic here
//                       >
//                         <div className="grid-cell" style={{flex: 1}}>{row.dmctg}</div>
//                       </div>
//                     ))}
//                   </div>
//                 </div>
...
//             {/* INPUT 2: DESIGN SELECTION (FILTERED) */}
//             <div className="input-wrapper" style={{position: 'relative', display: 'inline-block'}}>
//               <input 
//                 type="text" 
//                 className="w-md" 
...
//       console.log(res.data,"design list  :http://localhost:5000/api/users/dsgcd");
//       const dataToSet = res.data.data ? res.data.data : res.data;
//       setDsgData(dataToSet);
//     } catch (err) {
//       console.error("List API Error:", err);
...
//     try {
//       const res = await axios.get("http://localhost:5000/api/users/dsgcat");
//             console.log("cat list  :http://localhost:5000/api/users/dsgcat"); 
//       const dataToSet = res.data.data ? res.data.data : res.data; 
//       setCatData(dataToSet);
//     } catch (err) {
//       console.error("Category API Error:", err);
...
//     try {
//       console.log(`Fetching designs for: ${category}`); // Debugging
//       const res = await axios.get(`http://localhost:5000/api/users/dsgcat-by-ctg?dmctg=${category}`);
//       console.log("Filtered Designs :http://localhost:5000/api/users/dsgcat-by-ctg?dmctg=${category}"); // Debugging
//       const dataToSet = res.data.data ? res.data.data : res.data;
...
//     // 3. Second input box ko clear karo
//     setDesignCode(""); 

//     // 4. IMPORTANT: Purana data clear karein taaki user ko confusion na ho
//     setDsgData([]); 

//     // 5. API call karein (Directly item.dmctg bhej kar)
//     fetchDesignsByCategory(item.dmctg);
//   };
...
//               {
//                 console.log(formData.DmTcTyp,"formData.DmTcTyp")
//               }
