...
//     DmTcTyp: "", // <--- Iskey liye humne left input bind kiya hai
...
//   // --- Right Side Input States (Existing) ---
//   const [dsgData, setDsgData] = useState([]); 
//   const [designCode, setDesignCode] = useState(""); 
//   const [isDropdownOpen, setIsDropdownOpen] = useState(false); 

//   // --- NEW: Left Side Input States (Category) ---
//   const [catData, setCatData] = useState([]); // Category API data
//   const [isCatDropdownOpen, setIsCatDropdownOpen] = useState(false); // Toggle Category Dropdown

//   // Initial List Load
//   useEffect(() => {
//     fetchDsgList();
//     fetchCatList(); // <--- New API Call
//   }, []);

//   // 1. Fetch Existing Design Data
...
//   // 2. NEW: Fetch Category Data
//   const fetchCatList = async () => {
//     try {
//       const res = await axios.get("http://localhost:5000/api/users/dsgcat");
//       // API response structure handle karna (array ya object ke andar array)
//       const dataToSet = res.data.data ? res.data.data : res.data; 
...
//   // NEW: Left Side Select Handler
//   const handleCatSelect = (item) => {
//     // Input me value set karein
...
//             {/* --- NEW: LEFT SIDE INPUT WITH DROPDOWN --- */}
...
//                 <div className="dropdown-table" style={{width: '150px'}}> {/* Width adjust ki chote input ke liye */}
...
//             {/* --- EXISTING: RIGHT SIDE INPUT WITH DROPDOWN --- */}
//             <div className="input-wrapper" style={{position: 'relative', display: 'inline-block'}}>
//               <input 
//                 type="text" 
//                 className="w-md" 
...
//                     <div className="grid-cell" style={{width: '120px'}}>Size</div>
//                     <div className="grid-cell" style={{flex: 1}}>Dsg Ct</div>
...
//                         <div className="grid-cell" style={{flex: 1}}>{row.DmSz}</div>
//                         <div className="grid-cell" style={{flex: 1}}>{row.DmCtg}</div>
